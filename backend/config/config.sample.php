...
return [
    ...
    // Web Push (standard Push API, sent by PHP itself — no Node.js service).
    // Generate once with: php backend/tools/generate_vapid_keys.php
    'vapid' => [
        'subject'     => 'mailto:syndic@immeuble29.dz',
        'public_key'  => 'BFlFR3ZfmdloWT_FrAXxrcDGIWpHFY35inStO_OXFifXb9T6ItM5NvoeFykKUVbYBj5y_GbEyDF_qpuqZjRbQIg
',
        'private_key' => 'B7jVRzBmoCFhCMPg7Rrqqek15tGkvzWxxxqwF_bUhkM
',
    ],
