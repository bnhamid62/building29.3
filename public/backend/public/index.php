...
$r->get('/notifications/vapid-public-key', [NotificationsController::class, 'vapidKey']);
$r->post('/notifications/subscribe', [NotificationsController::class, 'subscribe']);
$r->post('/notifications/unsubscribe', [NotificationsController::class, 'unsubscribe']);
...
$r->get('/subscriptions/settings', [SubscriptionsController::class, 'settings']);
$r->patch('/subscriptions/settings', [SubscriptionsController::class, 'updateSettings']);
$r->get('/subscriptions/board', [SubscriptionsController::class, 'board']);
$r->get('/subscriptions/mine', [SubscriptionsController::class, 'mine']);
$r->get('/subscriptions', [SubscriptionsController::class, 'index']);
$r->post('/subscriptions', [SubscriptionsController::class, 'store']);
$r->post('/subscriptions/{id}/reverse', [SubscriptionsController::class, 'reverse']);
