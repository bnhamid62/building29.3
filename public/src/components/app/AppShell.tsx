...
import { Building2, Home, HardHat, Users, Wallet, DoorClosed, Settings, LogOut, Languages, Moon, Sun, Bell, FileText, ScrollText, PieChart, MessageSquareWarning, Vote, CalendarDays, CalendarClock, Cctv, Megaphone, Repeat } from "lucide-react";
...
const NAV = [
  ...
  { to: "/subscriptions", key: "subscriptions", icon: Repeat, manager: false },
